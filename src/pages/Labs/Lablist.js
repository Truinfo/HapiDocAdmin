...
import { Box, Button, Grid, IconButton, Menu, Breadcrumbs, Badge, MenuItem, TextField, Select, FormControl, InputLabel } from "@mui/material";
      ...
      <Grid style={{
        ...
        <Grid style={{ flexDirection: "column", padding: "0 0 0 15px", }}><Typography variant="h5" style={{
          ...
          <Breadcrumbs aria-label="breadcrumb" sx={{ fontSize: "12px", }}>
            ...
            <Typography color="#189ab4">Laboratories</Typography>
          </Breadcrumbs>
        </Grid>
      ...
      <Grid container spacing={2}>
        {labsData.map((lab, index) => (
          <Grid item xs={12} md={6} key={index}>
            <Link to="/lab-profile" style={{ textDecoration: 'none' }}>
              <Card
                sx={{
